////////////////////////////////////////////////////////////
// NIDEC actuator and sensor (encoder) hardware setup
////////////////////////////////////////////////////////////
...
// NIDEC pins: Motor connection
#define PWM 19 //Green wire  (PWM)
#define BRAKE 18 //Orange wire (Start/Stop)
#define DIR 23 //Yellow wire  (Forward/Reverse) 
#define ENCODER_CHA 13 //Blue wire    (Signal A)  
#define ENCODER_CHB 5 //Purple wire      (Signal B)
...
void ControlSystem::setup_sensors(void) {
  ...
  // Configuration for the BLDC NIDEC motor.
...
void ControlSystem::measure_signals(float t) {
  ...
  // BLDC Motor angular speed estimation in [deg/s]:
  ym[1] = (pos_motor - ym[0]) / (t - meas_last_t);

  // Update the BLDC Motor angular position measurement in [deg]:
  ym[0] = pos_motor;

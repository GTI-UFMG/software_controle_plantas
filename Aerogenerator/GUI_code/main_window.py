...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.radioButton_velocity = QRadioButton(self.verticalLayoutWidget_2)
        self.radioButton_velocity.setObjectName(u"radioButton_velocity")

        self.verticalLayout_8.addWidget(self.radioButton_velocity)

        self.radioButton_voltage = QRadioButton(self.verticalLayoutWidget_2)
        self.radioButton_voltage.setObjectName(u"radioButton_voltage")
        self.radioButton_voltage.setChecked(True)

        self.verticalLayout_8.addWidget(self.radioButton_voltage)
...
"border-color: rgb(85, 0, 255);")
        ...
        self.label_manual_input.setGeometry(QRect(10, 50, 91, 41))
...
"(envia para a Plataforma).", None))
        ...
        self.radioButton_velocity.setText(QCoreApplication.translate("MainWindow", u"Velocidade Angular [rpm]", None))
        self.radioButton_voltage.setText(QCoreApplication.translate("MainWindow", u"Tens\u00e3o gerada [mV]", None))
